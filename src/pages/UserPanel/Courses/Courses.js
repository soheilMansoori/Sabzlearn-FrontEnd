      ...
      <div className="courses">
        <div className="courses-header__panel">
          ...
          <ul className="courses-header__list">
            ...
            >
              <a
                class={`courses-header__link__panel ${showCourseState === "all"
            ...
            >
              <a
                class={`courses-header__link__panel ${showCourseState === "free"
                    ? "courses-header__link-active"
                    : null
                  }`}
                href="#"
            ...
            >
              <a
                class={`courses-header__link__panel ${showCourseState === "money"
                    ? "courses-header__link-active"
                    : null
                  }`}
                href="#"
